...
class RiskDashboard(QGroupBox):
    ...
    def __init__(
        ...
        *,
        ...
        base_dir = Path(self._json_path).parent.parent  
        self._watcher_cfg = WatcherConfig(base_dir=base_dir)
    ...
    # ---------------- UI ----------------
    @staticmethod
    def _tune_table(tbl: QTableWidget):
